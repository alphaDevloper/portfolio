...
function About() {
  ...
  return (
    <>
      <SEO
        title="About Me - Abdullah Alam"
        description="Learn more about Abdullah Alam, a passionate Full Stack Developer specializing in frontend and backend development, UI/UX design, and Figma."
        url="https://portfolio-123-lemon.vercel.app/#about"
      />
