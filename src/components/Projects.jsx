...
function Projects() {
  return (
    <>
      <SEO
        title="Projects - Abdullah Alam"
        description="Explore a selection of recent projects by Abdullah Alam, showcasing expertise in full-stack development, UI/UX design, and modern web technologies."
        url="https://portfolio-123-lemon.vercel.app/#projects"
      />
